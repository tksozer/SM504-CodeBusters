...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<VendomaticDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<VendomaticDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<VendomaticDbContext, Task<T>> action)
