namespace VendomaticApi.IntegrationTests;

using VendomaticApi.Extensions.Services;
using VendomaticApi.Databases;
using VendomaticApi.Resources;
using VendomaticApi.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.VendomaticApiKey] = _dbContainer.ConnectionString;
    ...
    {
        var options = new DbContextOptionsBuilder<VendomaticDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new VendomaticDbContext(options, null, null, null);
    ...
    private static TestcontainerDatabase DbSetup()
    {
        return new TestcontainersBuilder<PostgreSqlTestcontainer>()
            ...
            .WithName($"IntegrationTesting_VendomaticApi_{Guid.NewGuid()}")
