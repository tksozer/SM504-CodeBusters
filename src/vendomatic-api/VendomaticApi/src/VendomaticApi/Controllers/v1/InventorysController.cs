...
[ApiVersion("1.0")]
public sealed class InventorysController: ControllerBase
{
    private readonly IMediator _mediator;

    public InventorysController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    /// <summary>
    /// Gets a list of all Inventorys.
    /// </summary>
    [HttpGet(Name = "GetInventorys")]
    public async Task<IActionResult> GetInventorys([FromQuery] InventoryParametersDto inventoryParametersDto)
    {
