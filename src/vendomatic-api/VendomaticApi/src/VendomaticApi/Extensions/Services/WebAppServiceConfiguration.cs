...
using VendomaticApi.Middleware;
...
public static class WebAppServiceConfiguration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCorsService("VendomaticApiCorsPolicy", builder.Environment);
        builder.OpenTelemetryRegistration(builder.Configuration, "VendomaticApi");
        ...
        // registers all services that inherit from your base service interface - IVendomaticApiScopedService
    ...
    private static void AddBoundaryServices(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        foreach (var assembly in assemblies)
        {
            var rules = assembly.GetTypes()
                .Where(x => !x.IsAbstract && x.IsClass && x.GetInterface(nameof(IVendomaticApiScopedService)) == typeof(IVendomaticApiScopedService));
